<script lang="ts">
	...
	import WordMark from './svg/WordMark.svg.svelte';
...
<header class="p-4 md:p-6">
	<nav
		class="font mx-auto flex max-w-6xl flex-col justify-between py-2 font-medium text-white md:flex-row md:items-center"
		aria-label="Main"
	>
